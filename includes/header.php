...
<head>
  ...
  <?php if (strpos($_SERVER['PHP_SELF'], '/sports/') !== false): ?>
    <link href="/assets/css/sports.css" rel="stylesheet">
  <?php endif; ?>
  <?php if (strpos($_SERVER['PHP_SELF'], '/conference/') !== false): ?>
    <link href="/assets/css/conference.css" rel="stylesheet">
  <?php endif; ?>
  ...
  <?php if (strpos($_SERVER['PHP_SELF'], '/residential/') !== false): ?>
    <link href="/assets/css/residential.css" rel="stylesheet">
  <?php endif; ?>
  <?php if (strpos($_SERVER['PHP_SELF'], '/services/') !== false): ?>
    <link href="/assets/css/services.css" rel="stylesheet">
  <?php endif; ?>
  <?php if (strpos($_SERVER['PHP_SELF'], '/mall/') !== false): ?>
    <link href="/assets/css/mall.css" rel="stylesheet">
  <?php endif; ?>
</head>
...
<body>
  <nav class="navbar navbar-expand-lg glass-nav">
    <div class="container">
      <a class="navbar-brand fw-bold text-gradient" href="/index.php">Arcadia</a>
      ...
      <div class="collapse navbar-collapse" id="nav">
        <ul class="navbar-nav ms-auto">
          <?php if (!empty($_SESSION['user'])): ?>
            <li class="nav-item"><a class="nav-link" href="/dashboard/index.php">لوحة التحكم</a></li>
          ...
          <?php else: ?>
            ...
            <li class="nav-item"><a class="nav-link" href="/auth/register.php">إنشاء حساب</a></li>
          <?php endif; ?>
