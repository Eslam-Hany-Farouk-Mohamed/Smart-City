...
<body>
                    ...
                    <?php if (!empty($user)): ?>
                        <li class="nav-item dropdown ms-lg-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="/dashboard/index.php"><i class="bi bi-speedometer2"></i> لوحة التحكم</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/auth/logout.php"><i class="bi bi-box-arrow-right"></i> تسجيل الخروج</a></li>
                            </ul>
                        </li>
                    <?php else: ?>
                        <li class="nav-item"><a class="btn btn-gradient ms-lg-2" href="/auth/login.php">تسجيل الدخول</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-6" data-aos="fade-up">
                    ...
                    <div class="mt-4 d-flex gap-3 flex-wrap">
                        ...
                        <a href="/auth/register.php" class="btn btn-lg btn-outline-light">إنشاء حساب</a>
                    </div>
                </div>
    ...
    <section id="hospital" class="section-padding bg-contrast">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/hospital/index.php" class="btn btn-lg btn-gradient">زيارة قسم المستشفى</a>
            </div>
        </div>
    </section>
    ...
    <section id="mall" class="section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/mall/index.php" class="btn btn-lg btn-gradient">زيارة قسم المول</a>
            </div>
        </div>
    </section>
    ...
    <section id="school" class="section-padding bg-contrast">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/school/index.php" class="btn btn-lg btn-gradient">زيارة قسم المدرسة</a>
            </div>
        </div>
    </section>
    ...
    <section id="worship" class="section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/worship/index.php" class="btn btn-lg btn-gradient">زيارة قسم دور العبادة</a>
            </div>
        </div>
    </section>
    ...
    <section id="sports" class="section-padding bg-contrast">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/sports/index.php" class="btn btn-lg btn-gradient">زيارة النادي الرياضي</a>
            </div>
        </div>
    </section>
    ...
    <section id="conference" class="section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/conference/index.php" class="btn btn-lg btn-gradient">زيارة قاعة المؤتمرات والفعاليات</a>
            </div>
        </div>
    </section>
    ...
    <section id="bank" class="section-padding bg-contrast">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/bank/index.php" class="btn btn-lg btn-gradient">زيارة قسم البنك</a>
            </div>
        </div>
    </section>
    ...
    <section id="security" class="section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/security/index.php" class="btn btn-lg btn-gradient">زيارة قسم الأمن والطوارئ</a>
            </div>
        </div>
    </section>
    ...
    <section id="residential" class="section-padding bg-contrast">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/residential/index.php" class="btn btn-lg btn-gradient">زيارة المنطقة السكنية</a>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="/services/index.php" class="btn btn-lg btn-gradient">زيارة قسم الخدمات</a>
            </div>
        </div>
    </section>
